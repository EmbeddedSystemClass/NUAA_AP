...
/**
 *********************************************************************
 * Description           :Add can-bus deriver
 *********************************************************************
 * 
...
#define ioctlUSE_BLOCKED_TX					0
#define ioctlUSE_BLOCKED_RX					1
...
#define ioctlUSE_MODE					101
#define ioctlSTART_CIRCULAR_BUFFER_RX_DMA       	104
#define ioctlTX_USE_INT_BIT (1)
#define ioctlTX_USE_DMA_BIT (1 << 1)
#define ioctlRX_USE_INT_BIT (1 << 2)
#define ioctlRX_USE_DMA_BIT (1 << 3)
