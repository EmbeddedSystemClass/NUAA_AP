...
#ifndef FREERTOS_IO_SPI_H
#define FREERTOS_IO_SPI_H
...
size_t FreeRTOS_SPI_read( Peripheral_Descriptor_t const pxPeripheralControl, void * const pvBuffer, const size_t xBytes );
portBASE_TYPE FreeRTOS_SPI_ioctl( Peripheral_Descriptor_t const pxPeripheralControl, uint32_t ulRequest, void *pvValue );

#endif /* FREERTOS_IO_SPI_H */
